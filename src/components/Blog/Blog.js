...
const Blog = () => {
    return (
        <div>
            <div>
                <h1 className="text-gray-800 mb-4  font-sans font-medium text-xl pt-8 pl-8">Question 1: What is the purpose of React Router?</h1>
            ...
            <div>
                <h1 className="text-gray-800 mb-4  font-sans font-medium text-xl pt-8 pl-8">Question 2: How does Context API works?</h1>
            ...
            <div>
                <h1 className="text-gray-800 mb-4  font-sans font-medium text-xl pt-8 pl-8">Question 3: What is UseRef?</h1>
